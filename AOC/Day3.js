function a(_input) {
  ...
  input.forEach((line, index) => {
    ...
    line.split("").forEach((char, _index) => {
      if (_index < numberEndIndex) return; // return when in middle of a number
      if (isNaN(char)) return; // return when no number

      indexOfCharacter = _index;
      numberStartIndex = _index;

      // Iterate further to get whole number - break when no more number folows
      while (!isNaN(line[indexOfCharacter])) {
        indexOfCharacter++;
      }

      numberEndIndex = indexOfCharacter;

      if (
        input[index - 1]
          ?.slice(
            numberStartIndex ? numberStartIndex - 1 : numberStartIndex,
            numberEndIndex + 1 === line.length
              ? numberEndIndex
              : numberEndIndex + 1
          )
          .split("")
          .filter((e) => e !== "." && isNaN(e)).length > 0
      ) {
        solution += parseInt(line.substring(numberStartIndex, numberEndIndex));
        return;
      }
      ...
      if (
        input[index][numberStartIndex - 1] &&
        input[index][numberStartIndex - 1] !== "."
      ) {
        solution += parseInt(line.substring(numberStartIndex, numberEndIndex));
        return;
...
a(`.479........155..............944.....622..............31.........264.......................532..........................254.........528.....
..............-...............%.....+...................=....111*.................495.......+.......558..................../..........*.....
